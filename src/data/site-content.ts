...
export const siteContent: Record<Language, SiteDictionary> = {
  ...
  ru: {
    ...
    hero: {
      ...
      title: "Создаем маркетинговые системы, которые приводят бренды к реальному росту.",
      description:
        "Стратегия, performance-маркетинг и креативная реализация для брендов, которым нужны ясность, стабильность и измеримые результаты.",

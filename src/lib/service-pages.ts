...
const googleAdsCopy: Record<Language, ServicePageCopy> = {
  ru: {
    ...
    hero: {
      ...
      title:
        "Контекстная реклама Google, которая приводит горячих клиентов",
      description:
        "Собираем поисковые и медийные кампании, выстраиваем корректную структуру, следим за ростом прибыли и ведем рекламу так, чтобы она стабильно приводила клиентов.",
      bullets: [
